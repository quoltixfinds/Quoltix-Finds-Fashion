  ...
  const html = `
    <section class="hero" aria-label="Introduction">
      <div class="hero-inner">
        ...
        <p class="hero-sub">
          Quoltix Finds - Fashion curates the fashion worth wearing — no checkout, no clutter.
    ...
    <section class="section" aria-labelledby="trending-all-heading">
      <div class="section-head">
        <h2 id="trending-all-heading">Trending across Quoltix Finds - Fashion</h2>
    ...
    <section class="section about-section" aria-labelledby="about-heading">
      <div class="about-grid">
        <div class="about-statement">
          <p class="eyebrow">Why Quoltix Finds - Fashion exists</p>
          <h2 id="about-heading">We're not a store.<br />We're a filter.</h2>
          <p>
            Quoltix Finds - Fashion is a curated space for fashion inspiration and trending styles. We highlight

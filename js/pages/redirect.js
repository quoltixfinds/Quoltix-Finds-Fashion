    ...
    const html = `
      <section class="redirect-page">
        <div class="redirect-card">
          ...
          <a class="view-btn" href="#/">Back to Quoltix Finds - Fashion</a>
        </div>
      </section>
    `;
  ...
  const html = `
    <section class="redirect-page">
      <div class="redirect-card">
        ...
        <p class="redirect-sub">You're being redirected to the retailer for this item. Quoltix Finds - Fashion is a discovery
